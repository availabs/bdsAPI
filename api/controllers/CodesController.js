...
module.exports = {
   ...
   */
	...
	FieldService.with_codes("firm", "sz", function(f_sz){
		...
		FieldService.with_codes("firm", "age", function(f_age){
		    FieldService.with_codes("esta", "sz", function(e_sz){
			FieldService.with_codes("esta", "isz", function(e_isz){
			    FieldService.with_codes("esta", "age", function(e_age){
  ...
  /**
   * `CodesController.esta_codes()`
   */
    esta_codes: function (req, res) {
	if(req.param("type")){
	    FieldService.with_codes("firm", req.param("type"), function(data){
		return res.json(data);
	    });
	} else{
	    FieldService.with_codes("esta", "sz", function(sz){
		FieldService.with_codes("esta", "isz", function(isz){
		    FieldService.with_codes("esta", "age", function(age){
			return res.json({"size": sz, "isize": isz, "age": age});
		    });
		});
	    });
